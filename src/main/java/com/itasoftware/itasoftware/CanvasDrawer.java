...
//        }
    ...
    private void setFOV(GraphicsContext gc, Vehicle v) {
        double fovX, fovY, fovRadius, fovStartAngle, fovStartAngleHalf, fovLength, fovLengthLeft;
        ...
        fovLengthLeft = v.getFovLengthLeft();

        drawVehicleFOV(gc, Color.LIGHTBLUE, fovX, fovY, fovRadius, fovStartAngleHalf, fovLengthLeft, false);
